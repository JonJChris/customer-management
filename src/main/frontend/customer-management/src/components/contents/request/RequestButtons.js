...
const RequestButtons = (props) => {
  ...
  return (
    <div className='border border-rounded mt-3 p-3'>
      <div className='row'>
        {uiFieldStore.uiButtons.Field_146_request_rework && uiFieldStore.uiButtons.Field_146_request_rework.isVisible &&
        ...
        {uiFieldStore.uiButtons.Field_209_request_save && uiFieldStore.uiButtons.Field_209_request_save.isVisible &&
          <div className='col-1'><button className='btn btn-primary'
        ...
        {uiFieldStore.uiButtons.Field_145_request_submit && uiFieldStore.uiButtons.Field_145_request_submit.isVisible &&
          <div className='col-1'><button className='btn btn-primary'
